...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/legal-entities', title: 'Legal Entities',  icon:'ni-briefcase-24 text-green', class: '', display: true,childmenu: {path:'/somepath',title: '',  icon: 'ni-tv-2 text-primary', class: '', display: false } },
   ...
   { path: '/payments', title: 'Payments',  icon:'ni-credit-card text-info', class: '' , display: true,childmenu: {path:'/somepath',title: '',  icon: 'ni-tv-2 text-primary', class: '', display: false }},
    ...
    {path: '/asset', title: 'My Assets', icon : 'ni-delivery-fast', class: '', display:true,childmenu: {path:'/somepath',title: '',  icon: 'ni-tv-2 text-primary', class: '', display: false }},
